          ...
          <div className="relative flex items-center gap-4">
            ...
            <div className="ml-auto flex items-center gap-3">
              ...
              <button
                ...
                className="px-4 py-2 bg-red-500/80 hover:bg-red-600 text-white rounded-lg text-sm font-medium transition-all duration-200 backdrop-blur-sm border border-white/30"
              >
                🚪 Logout
              </button>
            </div>
